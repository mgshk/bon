...
<div class="container-fluid">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      <h2><?php echo $text_your_details; ?></h2><br/>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="tel" name="telephone" value="<?php echo $telephone; ?>" placeholder="<?php echo $entry_telephone; ?>" id="input-telephone" class="form-control" readonly/>
        ...
        <div class="buttons clearfix">
          ...
          <div class="pull-right">
            <input type="submit" value="Save" class="acc--fv--btn" />
          </div>
        </div>
      </form>
