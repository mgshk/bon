...
<style>
	...
	.cat--sel i{font-size: 28px; color: #000;font-weight: bold;}
		...
		<div id="content" class="<?php echo $class; ?> seller--ret">
				...
				<div class="row">
					...
					<div class="col-sm-3">
						<div>
							...
							<?php } ?>
							<?php } ?> &nbsp; <?php if($review_count != ''){ ?><span class="str-votes"><a href="" onclick="$('a[href=\'#tab-sellerreview\']').trigger('click'); return false;"><?php echo $review_count; ?> Votes </a></span><?php } else { ?><a href="" onclick="$('a[href=\'#tab-sellerreview\']').trigger('click'); return false;"> 0 Votes </a><?php } ?>
						</div>
						<p class="rating-str">
			...
			<div class="row">
				...
				<div class="col-sm-3">
					...
					<div class="str-name-land"><?php echo substr($nickname, 0, 25); ?>
					</div>
					<div>
						<?php for ($i = 1; $i <= 5; $i++) { ?>
						<?php if ($seller_rating < $i) { ?>
					...
					<div class="row bon-prd--sc fixmee-sec" style="z-index: 1; background: #fff;">
						...
						<div class="">
							<div class="bon-navbar-search smallsearch col-sm-5 col-xs-12" style="display: inline-flex; margin-bottom:10px;">
								...
								<input class="bon-navbar-input col-xs-11" type="text" placeholder="Search for Products" id="prod_search" name="prod_search" value="<?php echo $prod_search; ?>">
			...
			<div class="modal-body review-frm-top">
				<form class="form-horizontal" id="form-sellerreview">
					...
					<div class="form-group required">
						...
						<input type="radio" name="rate_rating" <?php echo $selected; ?> value="<?php echo $cnt; ?>" />&nbsp;
						<?php } ?>
						<?php echo $entry_good; ?>
					</div>
					<div class="form-group required">
