            ...
            <div class="tab-content">
              ...
              <div class="tab-pane <?php if($_GET['tab_section'] == 'product'){ echo 'active'; }?>" id="tab-sellerproduct">
                <div class="--bon-res-scrooll">
                  ...
                  <p><input type="checkbox" class="allow-prod-cart" name="allow_products" <?php echo $checked_products; ?> id="allow_products"
                    value="allow_products"> Allow products to visible to buyer in store/entity page.</p>
                    ...
                    <div id="collapse1" class="panel-collapse collapse in">
                      <div class="panel-body">
                        <div class="panel-heading">
                          <ul class="--bon-res-scrooll">
                            <li>- Please enter accurate information.</li>
                            <li>- Store/Entity name, location, at least one main category and email ID are needed to get the
                              approval.
                            </li>
                            <li>- Get buyers attention more by filling other fields to get your store/entity verified.</li>
                            <li>- Store/Entity will be enforced for re-approval if you change it's name and/or add/modify it's
                              banner.
                            </li>
                            <ul>
                        </div>
                        ...
                        <form action="" method="post" enctype="multipart/form-data" id="form-profile" class="form-horizontal main--mb--bt">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-8">
                              <input type="text" maxlength="50" name="owner_name" placeholder="<?php echo $entry_owner_name; ?>" value="<?php echo $owner_name; ?>"
                                id="input-owner-name" class="form-control" required/>
                              <span class="input-group-btn">
									 </span>
                            </div>
