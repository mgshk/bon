  ...
  <div class="row">
	...
	<!--<h4>Category</h4>-->
		...
		<?php if(isset($child['children_lv3']) && count($child['children_lv3'])>0){ ?>
			       ...
			       <?php if($child_lv3['children_lv3_main_cat'] == $category['category_id']) { ?>
                               <li><i class="fa fa-hand-o-right"></i><a href="<?php echo $child_lv3['href']; ?>"><?php echo $child_lv3['name']; ?></a></li>
                                <?php  } } ?>
                            </ul>
                        <?php } ?>
                <?php } ?>
