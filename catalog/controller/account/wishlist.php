	...
	public function index() {
		...
		foreach ($results as $result) {
			...
			if ($product_info) {
				...
				$data['products'][] = array(
					'store_name' => $seller_info['nickname'],
					'store_link' => $this->url->link('seller/seller/info', 'seller_id=' . $product_info['seller_id'] . '&path='),
					...
					'price'      => $price,
					'special'    => $special,
					'href'       => $this->url->link('product/product&product_id=' . $product_info['product_id'] . '&path=&seller_id=' . $product_info['seller_id']),
