...
class Controllersellerprofilesellerprofile extends Controller
{
    ...
    public function profile()
    {
		...
		} elseif($this->request->get['nickname'] != '' && (strlen($this->request->get['nickname']) > 200)) {
			$json['error'] = $this->language->get('error_nickname');
		} elseif($this->request->get['seller_description'] != '' && (strlen($this->request->get['seller_description']) < 2000)) {
			$json['error'] = $this->language->get('error_seller_description');
		} elseif($this->request->get['owner_name'] != '' && (strlen($this->request->get['owner_name']) > 200)) {
			$json['error'] = $this->language->get('error_owner_name');
		} elseif($this->request->get['store_email'] != '' && (strlen($this->request->get['store_email']) > 100)) {
		...
		}*/ elseif($this->request->get['referred_by'] != '' && (strlen($this->request->get['referred_by']) != 10)) {
