...
class Controllersellerseller extends Controller
{
    public function index()
    {
        ...
        foreach ($results as $result) {
			...
			$seller_address = $seller_add[0]['company'].' '.$seller_add[0]['address_1'].' '.$seller_add[0]['address_2'].' '.$seller_add[0]['city'].' '.$seller_add[0]['postcode'];
			//echo "<pre>"; print_r($seller_address);
