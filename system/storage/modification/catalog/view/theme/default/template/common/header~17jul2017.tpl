		...
		<html dir="<?php echo $direction; ?>" lang="<?php echo $lang; ?>">
			...
			<head>
				...
				<style>
					...
					.rrt-bon-sub{left:100%; top: 45%; position: unset;}
				</style>
			</head>
			...
			<body class="<?php echo $class; ?>">
				<div class="container-fluid main--head">
					<div class="row top-header-new">
						...
						<div class="col-sm-10">
								...
								<div class="col-sm-9">
									<div id="top-links" class="nav pull-right">
										<ul class="list-inline">
											<li><a class="cursor" data-toggle="modal" data-target="#ad-model">Advertise &nbsp;&nbsp;&nbsp;|</a></li>
											...
											<li class="dropdown">
												...
												<ul class="dropdown-menu dropdown-menu-right" style="background-color: wheat;">
													...
													<li class="dropdown-submenu cursor">
													...
													<?php if($logged) { ?>
													<li style="border-top: 1px solid #000;"><a href="<?php echo $logout; ?>"><?php echo $text_logout; ?></a></li>
													<?php } ?>
													<?php } else { ?>
											...
											<li><a class="cursor" data-toggle="modal" data-target="#site_feedback" title="Feedback">Feedback |</a></li>
							...
							<?php if((isset($_GET['route']) && ($_GET['route'] != 'seller/seller/info' && $_GET['route'] != 'account/wishlist' && $_GET['route'] != 'checkout/checkout')) || !isset($_GET['route'])) { ?>
								<div class="col-xs-5">
									<!--<div class="row">-->
									<div id="logo">
										<?php if ($logo) { ?>
								...
								<div class="col-xs-2"><?php echo $cart; ?>
								</div>
							<?php } else { ?>
								<div class="col-xs-11" style="margin-top: 15px;"><button class="btn btn-primary pull-left" onclick="goBack()">Go Back</button></div>
							<?php } ?>
								<div class="col-xs-1">
								</div>
							...
							<div class="row header-sec">
									...
									<div class="header-heading">
										<div class="ui-icon-video" id="location-search">
											<div class="new-text-top">
												<input class="cursor" type="button" data-toggle="modal" data-target="#map_mod" placeholder="Current Location" id="location-search-val">
								...
								<!--<div class="col-sm-4 mit--hd">
									<div class="header-heading">
										<div class="ui-icon-video" id="location-search">
											<div class="new-text-top gray--app">
												<input class="cursor gray--app" type="button" data-toggle="modal" data-target="#map_moda" placeholder="Current Location" id="location-search-val">
												<span class="top-current-loc gray--app"><a class="cursor gray--app" type="button" data-toggle="modal" data-target="#map_mod"><i class="fa fa-map-marker"></i></a></span>
											</div>
										</div>
									</div>
								</div>
								<div class="col-sm-3 header-center-kms">
									...
									<form method="post" action="">
										...
										<div id="slider-range"></div>
										<div class="km--set">
											<a class="cursor gray--app" id="kms_seta"><i class="fa fa-refresh" aria-hidden="true"></i></a>
										</div>
										<input type="text" name="amount" id="amount" value="" readonly style="width: 20px; float: left;">
										<input type="text" name="amount1" id="amount1" value="" readonly style="width: 20px; float: right;">
									</form>
								</div>-->
								<!--<div class="col-sm-2 mit--hd fis-des">
									<?php echo $store_favouries; ?>
									</div>
									<div class="col-sm-2 mit--hd fis-des">
									<div class="str--fv">
										<a class="cursor free-list-top--bon" href="<?php echo $wishlist; ?>" id="wishlist-total" title="<?php echo $text_wishlist; ?>"><?php echo $text_wishlist; ?></a>
									</div>
									</div>-->
								<?php } else { ?>
								<div class="col-sm-7">
								...
								<div class="col-sm-2 str--fv fis-des tttt">
									<a class="free-list-top--bon" href="<?php echo $wishlist; ?>" id="wishlist-total" title="<?php echo $text_wishlist; ?>"><?php echo $text_wishlist; ?></a>
								</div>
								<div class="col-sm-1 mit--hd fis-des header_cart"><?php echo $cart; ?></div>
							</div>
						</div>
					</div>
				</div>				
					...
					<div class="modal-dialog main--ts-rt">
						...
						<div class="modal-content loc-pop">
							...
							<div class="modal-body loc-share-top stt--rrpp">
								...
								<button class="tet--nt" onclick="getLocation()">Auto detect my location</button>
								<p>OR</p>
								<button class="tet--nt" data-toggle="modal" data-target="#map_mod">Choose on map</button>
							</div>
					...
					<div class="modal-dialog">
						...
						<div class="modal-content loc-pop">
							...
							<div class="modal-body site-feedback-top">
								<form action="" method="post" enctype="multipart/form-data" id="form_site_feedback_main" class="form-horizontal">
									<div class="form-group">
										<div class="danger" id="site_feed_alt"></div>
									</div>
									<div class="form-group">
										<input type="text" name="fd_mobile_nums" id="fd_mobile_nums" value="" placeholder="Mobile number" required>
									</div>
									<div class="form-group">
				...
				<script>
					$('#button_site_feedback').on('click', function() {
					 $.ajax({
						...
						type: 'post',
						dataType: 'json',
						data: $("#form_site_feedback_main").serialize(),
						success: function(json) {
							if (json['success']) {
								$( '#form_site_feedback_main').each(function(){
								    this.reset();
								});
								$('#site_feed_alt').html('');
									...
									<div class="col-md-8 _bonlg clear">
										...
										<form action="index.php?route=account/login" method="post" id="main-log" class="form-horizontal" style="padding: 0px 15px;">
											...
											<div class="_email-log-bon">
												<input type="text" name="email" value="<?php echo $email; ?>" placeholder="Phone number" id="input-email" class="inputText" required/>
											</div>
											<ul class="_erroe-li">
											...
											<div class="_passwrd-log-bon">
												<input type="password" name="password" value="<?php echo $password; ?>" placeholder="Password" id="input-password" class="inputText" required/>                              
								...
								<div class="row _top-sign-in" style="display:none;">
									<div class="col-md-8 _bonlg clear">
										...
										<form id="sig_top_hd" class="form-horizontal" style="padding: 0px 15px;">
											...
											<div class="_email-log-bon">
												<input type="tel" name="telephone" value="" class="inputText cal-exp" placeholder="Enter the phone number" id="input-telephone" required disabled/>
											</div>
											<ul class="_erroe-li">
								...
								<div class="row _top-sign-otp" style="display:none;">
									<div class="col-md-8 _bonlg clear">
										...
										<form id="_top-sign-otp" class="form-horizontal" style="padding: 0px 15px;">
											...
											<div class="_email-log-bon">
												<input type="tel" name="otp" value="" maxlength="4" class="inputText" id="otp" placeholder="Enter the OTP sent to above mobile number" required/>
											</div>
											<div class="_email-log-bon">
												<input type="email" name="email" value="" class="inputText" id="input-email-otp" placeholder="Email ID" required disabled/>
											</div>
											<ul class="_erroe-li">
											...
											<div class="_again-passwrd-log-bon security_answer" style="display:none">
												<input type="text" name="security_answer" value="" id="security_answer" placeholder="Please enter the security answer" class="inputText" required/>
											</div>
											<ul class="_erroe-li">
								...
								<div class="row _forget-bon-sec"  style="display:none;">
									<div class="col-md-8 _bonlg clear">
										...
										<form id="forget-log-sec" class="form-horizontal" style="padding: 0px 15px;">
											...
											<div class="_email-log-bon">
												<input type="text" name="forgt-phn" value="" placeholder="Enter the phone number" id="forgt-phn-sec_nw" class="inputText" required disabled/>
											</div>
											<div class="_passwrd-log-bon">							 
												<input type="text" name="forgt-phn-otp" value="" maxlength="6" placeholder="Enter the OTP sent to above mobile number" id="forgt-phn-otp" class="inputText" required/>                              
											</div>
											<ul class="_erroe-li">
											...
											<div id="qus_ans">
												...
												<div class="_again-passwrd-log-bon security_answer">
													<input type="text" name="security_answer_sec" value="" id="security_answer_sec" placeholder="Please enter the security answer" class="inputText" required/>
												</div>
												<ul class="_erroe-li">
				...
				<script src="http://maps.googleapis.com/maps/api/js?key=AIzaSyB7yf4Wg0LtSvk3qlVRYP_OUIz0SAuf9XM&libraries=places"></script>
				<style>
					#examples a {
				...
				<div class="modal fade" id="map_mod" role="dialog">
					<div class="modal-dialog map-box">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<div class="map_canvas" style="height: 300px;width: 100%;margin: 0.6em;">Map Loading....</div>
								<form>
									<input id="geocomplete" type="text" placeholder="Type in an address" value="chennai" />
									<input id="find_nw" type="button" value="find" />
									<fieldset>
										<label>Latitude</label>
										<input name="lat" id="latitude" type="text" value="<?php echo $latitude; ?>">
										<label>Longitude</label>
										<input name="lng" id="longitude" type="text" value="<?php echo $longitude; ?>">
										<label>Formatted Address</label>
										<input name="formatted_address" type="text" value="">
									</fieldset>
									<a id="reset" href="#" style="display:none;">Reset Marker</a>
								</form>
								<!--<script src="//maps.googleapis.com/maps/api/js?v=3&amp;sensor=false&amp;key=AIzaSyCd8_dkSlkxLyjEb0vv8AC6_zX6P7ios2g&amp;libraries=places&amp;"></script>-->
								<script>
									$(function(){
										setTimeout(function(){
					...
					function loadMap() {
						$(function(){
							...
							var mapOptions = {
							       ...
							       var map = new google.maps.Map($("#geocomplete")[0], mapOptions);
							},8000);
						});
					}
