...
<div class="container-fluid">
	...
	<div class="row">
		...
		<?php $class = 'col-sm-12'; ?>
		<?php } ?>
		<div id="content" class="<?php echo $class; ?>" style="margin-top: 10px;">
			...
			<div class="row">
				...
				<?php $class = 'col-sm-4'; ?>
				<?php } ?>
				<div class="<?php echo $class; ?>" style="line-height: 1.5;">
					<div class="btn-group">
						<?php if($allow_cart == 1) { ?>
						<?php if(!$cus_logged) { ?>
						<button type="button" class="btn btn-default" title="<?php echo $button_wishlist; ?>" data-toggle="modal" data-target="#login_frc_buyer"><i class="fa fa-heart"></i></button>
						<?php } elseif($cus_logged && $login_type != 'seller') { ?>
						<button type="button" class="btn btn-default" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product_id; ?>');"><i class="fa fa-heart"></i></button>
					...
					<ul class="list-unstyled">
						...
						<li>Discount: <?php echo $discount_price; ?> <span style="text-transform: capitalize;"><?php echo $discount_type; ?></sapn></li>
						<?php } ?>
						<!--<?php if ($tax) { ?>
					...
					<div id="product">
						...
						<div class="form-group">
							...
							<?php if($allow_cart == 1) { ?>
							<?php if(!$cus_logged) { ?>
							<button type="button" data-toggle="modal" data-target="#login_frc_buyer" class="btn btn-primary btn-lg btn-block"><?php echo $button_cart; ?></button>
							<?php } elseif($cus_logged && $login_type != 'seller') { ?>
