		...
		<html dir="<?php echo $direction; ?>" lang="<?php echo $lang; ?>">
			...
			<head>
				...
				<style>
					...
					#pre_loaderr {text-align: -moz-center;}
					.content-one, .content-two {display:none;}
					.rrt-bon-sub li{background: #fff;}
					.modal-open .modal {overflow-y: scroll;}
					.free--list-bon a{color:#fff}
					.free--list-bon a:hover{color:#fff}
							...
							<div class="row fis-des">
								...
								<div class="col-sm-2">
									<?php if ($logged) { 
										...
										<?php } else { ?>
											<div class="free--list-bon"><a href="index.php?route=sellerprofile/sellerprofile&tab_section=store_detail#content"><div class="frr--list cursor">Free Listing</div></a></div>
										<?php } ?>
									<?php } else { ?>
								...
								<div class="col-sm-9">
									<div id="top-links" class="nav pull-right">
										<ul class="list-inline">
											...
											<?php } else { ?>
												<a href="<?php echo $seller_profile; ?>" title="<?php echo $text_seller_account; ?>" class="dropdown-toggle" data-toggle="dropdown"><?php //echo $text_seller_account; ?>Hi, User <span class="caret"></span> &nbsp;&nbsp;&nbsp;| </a>
											<?php } ?>
							...
							<div class="row sec-mob main-mob--res">
								...
								<div class="collapse navbar-collapse" id="myNavbar">
									<ul class="mob-menu">
										...
										<?php } else { ?>
											<a class="expand-one" title="<?php echo $text_seller_account; ?>"><?php //echo $text_seller_account; ?>Hi, User <span class="caret"></span></a>
										<?php } ?>											
									...
									<div class="header-heading">
										<div class="ui-icon-video" id="location-search">
											<div class="new-text-top">
												<input class="cursor" type="button" data-toggle="modal" onClick="showMyModalSetTitle(this.value)" placeholder="Current Location" id="location-search-val">
					...
					<div class="modal-dialog">
						...
						<div class="modal-content loc-pop">
							...
							<div class="modal-body">
								<div class="row">
									<div class="col-md-12">
										<form action="index.php?route=common/home/add_adv" method="post" enctype="multipart/form-data" id="advertise-loc" class="form-horizontal" style="padding: 0px 15px;">
								...
								<div class="row _top-sign-in" style="display:none;">
									<div class="col-md-8 _bonlg clear">
										...
										<form id="sig_top_hd" class="form-horizontal" style="padding: 0px 15px;">
											...
											<div class="_email-log-bon">
												<input type="tel" name="telephone" value="" class="inputText cal-exp" placeholder="Enter the phone number" id="input-telephone" required/>
											</div>
								...
								<div class="row _top-sign-otp" style="display:none;">
									<div class="col-md-8 _bonlg clear">
										...
										<form id="_top-sign-otp" class="form-horizontal" style="padding: 0px 15px;">
											...
											<div class="_email-log-bon">
												<input type="tel" name="otp" value="" maxlength="6" class="inputText" id="otp" placeholder="Enter the OTP sent to above mobile number" required/>
											</div>
											<ul class="_erroe-li">
												<li><span id="top-line-star-otp" class="text-dangers"></span></li>
											</ul>
											<div class="_email-log-bon">
												<input style="border: none;border-bottom: 1px solid #e0e0e0; " type="email" name="email" value="" class="inputText" id="input-email-otp" placeholder="Email ID" required disabled/>
											</div>
											<ul class="_erroe-li">
