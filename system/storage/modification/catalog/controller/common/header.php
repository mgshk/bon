...
//print_r($data['login_type']);
	...
	private function updateCustomerTwo($data) {
		$this->db->query("UPDATE " . DB_PREFIX . "address SET customer_id = '" . (int)$this->request->post['cus_d_up'] . "', firstname = '" . $this->db->escape($data['firstname']) . "', lastname = '" . $this->db->escape($data['lastname']) . "', address_1 = '" . $this->db->escape($data['address_1']) . "' WHERE customer_id = '" . (int)$this->request->post['cus_d_up'] . "'");

		//$address_id = $this->db->getLastId();

		//$this->db->query("UPDATE " . DB_PREFIX . "customer SET firstname = '" . $this->db->escape($data['firstname']) . "', lastname = '" . $this->db->escape($data['lastname']) . "', address_id = '" . (int)$address_id . "' WHERE customer_id = '" . (int)$this->request->post['cus_d_up'] . "'");

		$this->db->query("UPDATE " . DB_PREFIX . "customer SET firstname = '" . $this->db->escape($data['firstname']) . "', lastname = '" . $this->db->escape($data['lastname']) . "' WHERE customer_id = '" . (int)$this->request->post['cus_d_up'] . "'");
