...
$this->load->language('common/column_left');
		...
		$seller_advertise_total = $this->model_selleradvertise_selleradvertise->getTotalselleradvertise(array('filter_ad_status' => 'submitted'));
...
$data['text_seller_advertise_approval'] = $this->language->get('text_seller_advertise_approval');

			$data['seller_total'] = $seller_total;
$data['seller_product_total'] = $seller_product_total;
$data['seller_advertise_total'] = $seller_advertise_total;
			$data['seller_approval'] = $this->url->link('seller/seller', 'token=' . $this->session->data['token'] . '&filter_seller_approved=0', 'SSL');
$data['seller_product_approval'] = $this->url->link('seller/product', 'token=' . $this->session->data['token'] . '&filter_ad_status=2', 'SSL');

$data['seller_advertise_approval'] = $this->url->link('selleradvertise/selleradvertise', 'token=' . $this->session->data['token'] . '&filter_status=submitted', 'SSL');
