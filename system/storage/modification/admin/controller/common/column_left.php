...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
        ...
        // seller
			...
			// seller Ads
			$selleradvertise = array();
			
			if ($this->user->hasPermission('access', 'selleradvertise/selleradvertise')) {
				$selleradvertise[] = array(
					'name'	   => $this->language->get('pending_approval'),
					'href'     => $this->url->link('selleradvertise/selleradvertise', 'token=' . $this->session->data['token']. '&filter_ad_status=submitted', true),
					'children' => array()		
				);
			}
			...
			if ($this->user->hasPermission('access', 'selleradvertise/selleradvertise')) {
				$selleradvertise[] = array(
					'name'	   => $this->language->get('advertise_rejected'),
					'href'     => $this->url->link('selleradvertise/selleradvertise', 'token=' . $this->session->data['token']. '&filter_ad_status=rejected', true),
					'children' => array()		
				);
			}
			...
			if ($this->user->hasPermission('access', 'selleradvertise/selleradvertise')) {
				$selleradvertise[] = array(
					'name'	   => $this->language->get('advertise_approved'),
					'href'     => $this->url->link('selleradvertise/selleradvertise', 'token=' . $this->session->data['token']. '&filter_ad_status=approved', true),
					'children' => array()		
				);
			}
			...
			if ($selleradvertise) {
				$data['menus'][] = array(
					'id'       => 'menu-seller',
					'icon'	   => 'fa-buysellads', 
					'name'	   => $this->language->get('text_seller_ads'),
					'href'     => '',
					'children' => $selleradvertise
				);		
			}
			...
			if ($this->user->hasPermission('access', 'sitefeedback/sitefeedback')) {
				$site_feedback[] = array(
					'name'	   => $this->language->get('feedback_list'),
					'href'     => $this->url->link('sitefeedback/sitefeedback', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);
			}
			...
			if ($site_feedback) {
				$data['menus'][] = array(
					'id'       => 'menu-site-feedback',
					'icon'	   => 'fa-rss', 
					'name'	   => $this->language->get('feedback'),
					'href'     => '',
					'children' => $site_feedback
				);		
			}
