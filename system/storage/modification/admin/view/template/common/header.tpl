	...
	<body>
		...
		<header id="header" class="navbar navbar-static-top">
			<div class="navbar-header">
				...
				<?php } ?>
				<a href="<?php echo $home; ?>" class="navbar-brand"><img src="view/image/logo-new.png" alt="BoN<?php //echo $heading_title; ?>" title="<?php echo $heading_title; ?>" /></a>
			</div>
			<?php if ($logged) { ?>
			<ul class="nav pull-right">
			<li class="dropdown">
				<a class="dropdown-toggle" data-toggle="dropdown"><span class="label label-danger pull-left"><?php echo $seller_advertise_total; ?></span> <i class="fa fa fa-buysellads fw"></i></a>
				<ul class="dropdown-menu dropdown-menu-right alerts-dropdown">					
					<li><a href="<?php echo $seller_advertise_approval; ?>"><span class="label label-danger pull-right"><?php echo $seller_advertise_total; ?></span><?php echo $text_seller_advertise_approval; ?></a></li>
				</ul>
			</li>
			<li class="dropdown">
				<a class="dropdown-toggle" data-toggle="dropdown"><span class="label label-danger pull-left"><?php echo $seller_alerts; ?></span> <i class="fa fa-users fa-lg"></i></a>
				<ul class="dropdown-menu dropdown-menu-right alerts-dropdown">
			...
			<ul class="nav pull-right">
				<li class="dropdown">
					<a class="dropdown-toggle" data-toggle="dropdown"><?php if($alerts > 0) { ?><span class="label label-danger pull-left"><?php echo $alerts; ?></span><?php } ?> <i class="fa fa-bell fa-lg"></i></a>
					<ul class="dropdown-menu dropdown-menu-right alerts-dropdown">
