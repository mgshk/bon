        ...
        <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-seller">
              ...
              <thead>
                <tr>
                  ...
                  <td class="text-left">
                    ...
                    <a href="<?php echo $sort_date_added; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_date_modified; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_date_added; ?>"><?php echo $column_date_modified; ?></a>
                    <?php } ?>
				  </td>
		  ...
		  <?php } ?>
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($seller_ad['advertise_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $seller_ad['advertise_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $seller_ad['advertise_id']; ?>" />
                    <?php } ?></td>
                  <td class="text-center"><img src="<?php echo $seller_ad['offer_image']; ?>" alt="<?php echo $seller_ad['offer_title']; ?>" class="img-thumbnail"></td>
				  <td class="text-left"><?php echo $seller_ad['offer_title']; ?></td>                  
                  <td class="text-left"><?php echo $seller_ad['date']; ?></td>
		  <?php if($request=='submitted'){ ?>
                  <td class="text-right">
                   
                    <a class="btn btn-primary" data-toggle="modal" data-target="#myModalad_<?php echo $seller_ad['advertise_id']; ?>" ><i class="fa fa-eye" aria-hidden="true"></i>
</a>
                    </td>
		    <?php } ?>
                </tr>
