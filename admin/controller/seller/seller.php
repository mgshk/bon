...
class ControllerSellerseller extends Controller
{
    ...
    public function approve()
    {
        ...
        if ($sellers && $this->validateApprove()) {
			...
			$main2 = imagecreatefromjpeg('view/image/qr_images/main2.jpg');
	...
	public function verify()
    {
        ...
        if ($sellers && $this->validateApprove()) {
            $verify_comment = $this->language->get('verify_comment');
            $this->model_seller_seller->addHistory($this->request->get['seller_id'], $verify_comment);
            ...
            $this->model_seller_seller->addTransaction($this->request->get['seller_id'], $transaction_approve_comment, $seller_group_info['subscription_price'] * -1);
            $this->model_seller_seller->verify($this->request->get['seller_id']);			
    ...
    public function disverify()
    {
		...
		//print_r($this->request->get['reason']); die;
        if ($sellers && $this->validatedisapprove()) {
            $disverify_comment = $this->language->get('disverify_comment');
            $this->model_seller_seller->addHistory($this->request->get['seller_id'], $disverify_comment);
            $this->model_seller_seller->disverify($this->request->get['seller_id']);
